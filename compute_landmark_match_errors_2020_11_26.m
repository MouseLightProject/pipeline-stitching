...
% make a z-match RMSE stack
final_affine_z_match_count_from_tile_ijk1 = nan(size(tile_index_from_tile_ijk1)) ;
...
for pair_index = 1 : pair_count ,
    ...
    final_affine_z_match_count_from_tile_ijk1(tile_ijk1(1), tile_ijk1(2), tile_ijk1(3)) = z_match_count_from_pair_index(pair_index) ;    
end
...
final_affine_z_match_count_from_tile_ijk1_montage = montage_from_stack_ijk(final_affine_z_match_count_from_tile_ijk1) ;
f = figure('color', 'w') ;
a = axes(f) ;
imagesc(final_affine_z_match_count_from_tile_ijk1_montage, [0 600]) ;
colorbar(a) ;
title('Final affine Z-Match Count') 
drawnow
