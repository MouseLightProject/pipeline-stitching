function [neuron_channel_index, background_channel_index] = read_channel_semantics_file(channel_semantics_file_name)    
    % Read the channel semantics file and extract the relevant information
    channel_semantics_lines = read_file_into_cellstring(channel_semantics_file_name) ;
