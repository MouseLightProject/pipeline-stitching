...
max_dxy_norm_self_tile_index = self_tile_index_from_pair_index(max_dxy_norm_pair_index) 
max_dxy_norm_neighbor_tile_index = neighbor_tile_index_from_pair_index(max_dxy_norm_pair_index) 

% Look at the self tile
relative_path = relative_path_from_tile_index{max_dxy_norm_self_tile_index} ;
imagery_file_relative_path = imagery_file_relative_path_from_relative_path(relative_path, working_channel_index) ;
imagery_file_path = fullfile(imagery_tile_path, imagery_file_relative_path) 
raw_tile_stack_yxz_flipped = read_16bit_grayscale_tif(imagery_file_path) ;
raw_tile_stack_yxz = flip(flip(raw_tile_stack_yxz_flipped, 1), 2) ;
...
imshow(raw_tile_stack_yxz_mip, ...
       ...
       'DisplayRange', [min(min(raw_tile_stack_yxz_mip)) max(max(raw_tile_stack_yxz_mip))], ...
       'Colormap', parula(256)) ;
title_string = sprintf('Tile %d (%s)', max_dxy_norm_self_tile_index, relative_path) ;
title(a, title_string) ;
colorbar(a) ;

% Look at the neighbor tile
relative_path = relative_path_from_tile_index{max_dxy_norm_neighbor_tile_index} ;
imagery_file_relative_path = imagery_file_relative_path_from_relative_path(relative_path, working_channel_index) ;
imagery_file_path = fullfile(imagery_tile_path, imagery_file_relative_path) 
raw_tile_stack_yxz_flipped = read_16bit_grayscale_tif(imagery_file_path) ;
raw_tile_stack_yxz = flip(flip(raw_tile_stack_yxz_flipped, 1), 2) ;
...
imshow(raw_tile_stack_yxz_mip, ...
       ...
       'DisplayRange', [min(min(raw_tile_stack_yxz_mip)) max(max(raw_tile_stack_yxz_mip))], ...
       'Colormap', parula(256)) ;
title_string = sprintf('Tile %d (%s)', max_dxy_norm_neighbor_tile_index, relative_path) ;
title(a, title_string) ;
colorbar(a) ;
