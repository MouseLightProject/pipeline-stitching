...
raw_tile_path = sprintf('/groups/mousebrainmicro/mousebrainmicro/data/test-data/test-unscaled/2021-03-17') ;
pipeline_output_folder_path = sprintf('/nrs/mouselight/pipeline_output/test-unscaled/2021-03-17-adam-classifier')  %#ok<NOPTS> 
...
raw_tile_index = compute_or_read_from_memo(sample_memo_folder_path, ...
                                           sprintf('raw-tile-index-%s', sample_tag), ...
...
match_info = ...
    compute_or_read_from_memo(analysis_memo_folder_path, ...
                              sprintf('z-face-matches-%s-channel-%d', sample_tag, background_channel_index), ...
