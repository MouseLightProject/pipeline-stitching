function vecfield = vectorField3D(params, scopeloc, regpts, scopeparams, curvemodel, tile_k_from_run_layer_index)
    ...
    for run_layer_index = 1 : run_layer_count ,
        ...
        [Fx_layer, Fy_layer, Fz_layer, Fx_next_layer, Fy_next_layer, Fz_next_layer, XYZ_original, XYZ_neighbor_original, outliers] =...
            util.getInterpolants(tile_index_from_tile_within_layer_index, ...
                                 regpts, ...
        ...
        do_run_optimpertile_from_tile_within_layer_index = do_run_optimpertile_from_tile_index(tile_index_from_tile_within_layer_index) ;
        tile_index_from_optimpertile_tile_index = tile_index_from_tile_within_layer_index(do_run_optimpertile_from_tile_within_layer_index) ;
        for tile_index = tile_index_from_optimpertile_tile_index ,
        ...
        % ?
        do_run_nomatchoptim_from_tile_within_layer_index = do_run_nomatchoptim_from_tile_index(tile_index_from_tile_within_layer_index) ;
        tile_index_from_nomatchoptim_tile_index = tile_index_from_tile_within_layer_index(do_run_nomatchoptim_from_tile_within_layer_index) ;                
        anchorinds = tile_index_from_optimpertile_tile_index ;
        anchors = tile_ijk_from_tile_index(anchorinds,:) ;        
        queryinds = tile_index_from_nomatchoptim_tile_index ;
        queries = tile_ijk_from_tile_index(queryinds,:) ;
        ...
        % ?
        for tile_index = tile_index_from_nomatchoptim_tile_index ,
